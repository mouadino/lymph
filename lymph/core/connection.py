...
class Connection(object):
    def __init__(self, rpc_server, endpoint, heartbeat_interval=1, timeout=1, idle_timeout=10, unresponsive_disconnect=30, idle_disconnect=60):
        ...
        self.heartbeat_loop_greenlet = self.rpc_server.spawn(self.heartbeat_loop)
        self.live_check_loop_greenlet = self.rpc_server.spawn(self.live_check_loop)
    ...
    def heartbeat_loop(self):
        while True:
            ...
            channel = self.rpc_server.ping(self.endpoint)
            try:
    ...
    def close(self):
        ...
        self.rpc_server.disconnect(self.endpoint)
